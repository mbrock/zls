// copied wholesale from zig source to access secret non-pub decls
...
pub fn renderMembers(r: *Render, members: []const Ast.Node.Index) Error!void {
    const tree = r.tree;
...
pub fn renderVarDeclWithoutFixups(
    r: *Render,
    var_decl: Ast.full.VarDecl,
    /// Destructures intentionally ignore leading `comptime` tokens.
    ignore_comptime_token: bool,
...
/// .comma is introduced.
pub const AutoIndentingStream = struct {
