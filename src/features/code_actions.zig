...
const GenerateMoveDeclToTopLevelActionator = @import("GenerateMoveDeclToTopLevelActionator.zig");
const GenerateMoveTopLevelStructToFileActionator = @import("GenerateMoveTopLevelStructToFileActionator.zig");
const GenerateHoistConstToFieldActionator = @import("GenerateHoistConstToFieldActionator.zig");
const GenerateEncapsulateParamsStructActionator = @import("GenerateEncapsulateParamsStructActionator.zig");
const GenerateExtractFunctionCodeActionator = @import("GenerateExtractFunctionCodeActionator.zig");
...
pub const Builder = struct {
    ...
    pub fn wantKind(builder: *Builder, kind: std.meta.Tag(types.CodeActionKind)) bool {
    ...
    pub fn generateCodeActionsInRange(
        ...
        generateMoveTopLevelStructToFileAction(builder, start_index) catch |err| {
            std.debug.print("Failed to generate move top level struct to file action: {}\n", .{err});
        };
...
pub const EditBuilder = @import("EditBuilder.zig").EditBuilder;
